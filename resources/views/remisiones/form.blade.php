    ...
    <div class="box-body">
            ...
            <div class="card mb-3 shadow-sm">
                <div class="card-body">
                    <div class="row align-items-end">
                        <div class="col-md-8">
                            {{ Form::label('clonar_remision_id', 'Clonar desde remisión') }}
                            {{ Form::select('clonar_remision_id', $remisionesParaClonar ?? [], request('clone_id'), [
                                'class' => 'form-select select2',
                                'id' => 'clonar_remision_id',
                                'placeholder' => 'Selecciona una remisión...',
                            ]) }}
                        </div>
                        <div class="col-md-4">
                            <button type="button" class="btn btn-outline-secondary w-100" id="btnClonarRemision">
                                <i class="fas fa-clone me-1"></i> Clonar
                            </button>
                        </div>
                    </div>
                    <small class="text-muted">
                        Copia la remisión seleccionada (incluye productos). El consecutivo queda vacío.
                    </small>
                </div>
            </div>
        @endif
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                ...
                {{ Form::text('consecutivo', $data->consecutivo ?? '', [
            ...
            <div class="col-md-4">
                ...
                {{ Form::text('contacto', $data->contacto ?? '', [
            ...
            <div class="col-md-4">
                ...
                {{ Form::select('cliente_id', $clientes ?? [], $data->cliente_id ?? null, [
        ...
        {{-- segunda fila: tipo evento, ciudad, estado --}}
        <div class="row mb-3">
            <div class="col-md-4">
                {{ Form::label('tipo_evento_id', 'Tipo de evento') }}
                {{ Form::select('tipo_evento_id', $tipoEventos ?? [], $data->tipo_evento_id ?? null, [
            ...
            <div class="col-md-4">
                ...
                {{ Form::select('ciudad_id', $ciudades ?? [], $data->ciudad_id ?? null, [
        ...
        {{-- tercera fila: logistíca --}}
        <div class="row mb-4">
            <div class="col-md-3">
                {{ Form::label('lugar', 'Lugar') }}
                {{ Form::text('lugar', $data->lugar ?? '', [
            ...
            <div class="col-md-3">
                ...
                {{ Form::datetimeLocal('fecha_evento', $data->fecha_evento ?? '', [
            ...
            <div class="col-md-3">
                ...
                {{ Form::datetimeLocal('fecha_montaje', $data->fecha_montaje ?? '', [
            ...
            <div class="col-md-3">
                ...
                {{ Form::text('transporte', $data->transporte ?? '', [
        ...
        {{-- cuarta fila: logistíca segunda pate --}}
        <div class="row">
            <div class="col-md-2">
                {{ Form::label('placa', 'Placa') }}
                {{ Form::text('placa', $data->placa ?? '', [
            ...
            <div class="col-md-2">
                ...
                {{ Form::text('id_conductor', $data->id_conductor ?? '', [
            ...
            <div class="col-md-2">
                ...
                {{ Form::text('destino', $data->destino ?? '', [
            ...
            <div class="col-md-4">
                ...
                {{ Form::select('personal_ids[]', $users ?? '', $data->personal_ids_array ?? [], [
        ...
        <div class="row">
            {{-- IZQUIERDA: listado de productos (agrupado si corresponde) --}}
            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="table-responsive" style="max-height: 520px; overflow-y: auto;">
                            ...
                            @if ($grupos->isNotEmpty())
                                @foreach ($grupos as $subref => $items)
                                    @php
                                        $padre = $items->first();
                                    ...
                                    <div class="product-group mb-3" data-grupo="{{ $padre->grupo_id }}"
                                        ...
                                        <div
                                            ...
                                            <button class="btn btn-link text-start p-0 fw-bold toggle-subref"
                                                ...
                                                <i class="fas fa-caret-right me-1"></i>
                                                {{ $subref }} <small
                                                    class="text-muted">({{ $cantidadHijos }})</small>
                                            </button>
                                            ...
                                            <ul class="list-group list-group-flush border">
                                                @foreach ($items as $p)
                                                    <li class="list-group-item d-flex justify-content-between align-items-center product-row"
                                                        data-name="{{ strtolower($p->nombre) }} {{ strtolower($p->codigo_qr) }}"
                                    ...
                                    @if (isset($data) && $data->detalles && $data->detalles->isNotEmpty())
                                        @foreach ($data->detalles as $det)
                                            @php
                                                ...
                                                // inventarios[] -> "combo" combo, "1" serie, "0" normal
                                            ...
                                            <tr data-key="{{ $rowId }}__inv{{ $inv }}"
                                                ...
                                                {{-- <td>
                                                    @if ($isSerie)
                                                        {{ $det->referencia->nombre ?? ($det->producto->nombre ?? '') }}
                                                        <div><small
                                                                class="text-muted">{{ $det->referencia->codigo ?? ($det->producto->codigo_qr ?? '') }}</small>
                                                        </div>
                                                    @else
                                                        {{ $det->producto->nombre ?? '' }}
                                                        <div><small
