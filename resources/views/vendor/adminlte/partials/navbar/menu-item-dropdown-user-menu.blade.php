...
<li class="nav-item dropdown user-menu">
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-footer">
            ...
            @if ($profile_url)
                <a href="{{ $profile_url }}" class="btn btn-default btn-flat btn-block">
            ...
            {{-- Cambiar contraseña --}}
            <a href="{{ route('usuario.form.cambiar-contrasena') }}" class="btn btn-default btn-flat btn-block">
            ...
            <form id="logout-form" action="{{ $logout_url }}" method="POST" class="d-none">
