<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::hidden('id_comprador', $usuario['id'], ['class' => 'form-control'. ($errors->has('id_comprador') ? ' is-invalid' : '')]) }}
            {{ Form::text('nombre', $usuario['nombre'], ['class' => 'form-control', 'readonly' . ($errors->has('id_comprador') ? ' is-invalid' : '')]) }}
        ...
        <div class="form-group">
            ...
            {{ Form::select('id_cliente', $clientes, $venta->id_cliente,['class' => 'form-control select2' . ($errors->has('id_cliente') ? ' is-invalid' : ''), 'placeholder' => 'Seleccione un cliente']) }}
        ...
        ======================================-->
        <button type="button" class="btn btn-success btn-block btnAgregarProducto">Agregar producto</button>
        <hr>
        <div class="form-group">
            {{ Form::label('total') }}
